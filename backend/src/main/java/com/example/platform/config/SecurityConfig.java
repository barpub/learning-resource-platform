...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/api/resources/**", "/api/categories/**", "/api/comments/**", "/api/search/global", "/api/forum/**", "/api/agent/search", "/api/agent/resources/*/summary", "/api/agent/folders/*/summary").permitAll()
