...
const routes = [
  ...
  { path: '/agent/search', redirect: '/search' },
  { path: '/agent/analyze', component: () => import('../views/FolderAnalysisAgent.vue') },
  { path: '/resources', component: () => import('../views/ResourceList.vue') },
  { path: '/beta/recommendations', component: () => import('../views/BetaRecommendations.vue') },
  { path: '/beta/master-repair', component: () => import('../views/BetaMasterRepair.vue') },
